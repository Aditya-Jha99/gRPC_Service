...
type WordClient interface {
	GetWords(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *wordClient) GetWords(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/word.Word/GetWords", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WordServer interface {
	GetWords(context.Context, *Request) (*Response, error)
...
func (UnimplementedWordServer) GetWords(context.Context, *Request) (*Response, error) {
...
func _Word_GetWords_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WordServer).GetWords(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/word.Word/GetWords",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WordServer).GetWords(ctx, req.(*Request))
	}
...
var Word_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetWords",
			Handler:    _Word_GetWords_Handler,
		},
	},
